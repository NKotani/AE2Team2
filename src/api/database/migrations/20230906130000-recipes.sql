...
INSERT INTO recipes (
        ...
        "約30分", "12-100-1530", 
        "たらの芽", "3", 
        '[{"name": "タラの芽", "quantity": "6", "unit": "本"}, {"name": "薄力粉（生地用）", "quantity": "100", "unit": "グラム"}, {"name": "水", "quantity": "1", "unit": "カップ"}, {"name": "日本酒", "quantity": "30", "unit": "cc"}, {"name": "薄力粉（具にまぶす分）", "quantity": "100", "unit": "グラム"}]', '["・タラの芽を洗って、袴を取り除きます。", "・計量した薄力粉、水、ボールを冷蔵庫で冷やします。", "・タラの芽の茎に、十字の切り込みを入れます。※タラの芽が小ぶりの時は必要ありません。", "・ボールに水と日本酒、氷少々を入れます。・生地用の薄力粉を加えて、ざっくり混ぜます。", "油を180度に熱しておきます。", "・まぶし用の薄力粉をポリ袋に入れます。・タラの芽を入れて、振りながら、粉を全体にまぶします。", "・余分な粉をはたき落とし、生地をくぐらせます。", "・余分な生地が付いていたら、振り落とします。", "・油に根元の方を入れて、5秒ほど待ちます。・全体を入れます。", "・油の表面が隠れない程度に、次々に、具材を入れます。※具材に火が通っていないうちは、大きい泡になります。・途中具材の裏表を返します。", "・泡が小さくなって、揚げ色が付いたら揚げあがりです。", "網に乗せて、油を切ります。", "・お好みの天つゆなどを用意します。※今日は大根おろし添えの天つゆと、炭塩を用意しました。", "・油を吸い取る紙を敷いた皿に、盛り付けます。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約10分", "12-101-31", 
        "ゴーヤ", "2", 
        '[{"name": "ゴーヤ", "quantity": "3", "unit": "分の"}, {"name": "ツナ", "quantity": "50", "unit": "g"}, {"name": "★塩", "quantity": "0", "unit": "少々"}, {"name": "★マヨネーズ", "quantity": "10", "unit": "g"}, {"name": "（ミニトマト）", "quantity": "2", "unit": "("}]', '["ゴーヤを薄めに切る。沸騰したお湯に入れて塩ゆでする。（１分）ざるにあげて、軽くしぼる。", "ボールに、ゴーヤ、油きりしたツナ、★を入れ、混ぜ合わせたら出来上がり！トマトを飾るとキレイです。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
