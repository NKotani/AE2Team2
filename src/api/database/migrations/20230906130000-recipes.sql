...
INSERT INTO recipes (
        ...
        "3", "子供が喜ぶウインナーとジャガイモのチーズ焼き", "https://recipe.rakuten.co.jp/recipe/1900012525/", 
        "https://image.space.rakuten.co.jp/d/strg/ctrl/3/79b725a01f97749ed1b1fe6915b1aa673beb2e61.18.2.3.2.jpg", "100円以下", 
        "約10分", "10-66-50", 
        "ソーセージ・ウインナー", "4", 
        '[{"name": "ウインナー", "quantity": "5", "unit": "本"}, {"name": "ジャガイモ", "quantity": "2", "unit": "中"}, {"name": "玉ねぎ", "quantity": "0", "unit": "中半分"}, {"name": "塩", "quantity": "0", "unit": "ひとつまみ"}, {"name": "こしょう", "quantity": "2", "unit": "ふりぐらい"}, {"name": "チーズ", "quantity": "40", "unit": "g"}]', '["ジャガイモは5mm角の3cmぐらいに切り、玉ねぎはうすぎり、ウインナーはジャガイモと大体同じ大きさに切る。", "じゃがいもをレンジで柔らかくする。", "ウインナーと玉ねぎを最初にフライパンに入れ中火で炒め、その後ジャガイモをいれて水分をとばし、塩こしょうをする。", "耐熱皿かアルミホイルにのせて、その上にチーズをのせる。", "トースター、グリルなどで５分ほど焼き、チーズがとけて焼き目がついたらできあがり♡"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "3", "【超簡単　豪華】フライパンだけで絶品ラムチョップ", "https://recipe.rakuten.co.jp/recipe/1220010619/", 
...
INSERT INTO recipes (
        ...
        "3", "簡単本格的チャーシュー風スペアリブ", "https://recipe.rakuten.co.jp/recipe/1550003302/", 
        "https://image.space.rakuten.co.jp/d/strg/ctrl/3/72cd41326efc721476bdd6fffd11288f32524a6f.86.2.3.2.jpg", "指定なし", 
        "指定なし", "10-69-460", 
        "猪肉", "3", 
        '[{"name": "スペアリブ", "quantity": "10", "unit": "本ぐらい"}, {"name": "チャーシュー醤材料", "quantity": "0", "unit": 0}, {"name": "ローズマリー", "quantity": "2", "unit": "枝"}, {"name": "にんにくおろし", "quantity": "1", "unit": "小さじ"}, {"name": "しょうがおろし", "quantity": "1", "unit": "小さじ"}, {"name": "はちみつ", "quantity": "50", "unit": "g"}, {"name": "中華甘みそ　甜面醤テンメンジャン", "quantity": "1", "unit": "小さじ"}, {"name": "オイスターソース", "quantity": "1", "unit": "大さじ"}, {"name": "醤油", "quantity": "2", "unit": "大さじ"}, {"name": "みりん", "quantity": "2", "unit": "大さじ"}, {"name": "お酒", "quantity": "1", "unit": "大さじ"}, {"name": "鷹の爪（八角）", "quantity": "1", "unit": "個"}, {"name": "五香粉（ウーシャンフェン）", "quantity": "0", "unit": "少々"}, {"name": "黒コショウ", "quantity": "0", "unit": "少々"}]', '["チャーシュー醤材料ずべてお揃え、中火でまぜながら、煮立てます。一度沸騰してから、火からおろし、", "粗熱がなくなったら、スペアリブにかけ、半日ぐらい漬け込む。", "200℃予熱してから１８０℃まで下がって１５分焼きます。", "いったん出して、裏にして、残ったチャーシュー醤をスペアリブにかけてから、また１８０℃で１５分焼く、", "途中見ながら、ちょっと焦げつけたら、完成です！", "このチャーシュー醤でチャーシューも作れます！いろいろチャレンジしてみてください。おいしいです！"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約15分", "11-70-2017", 
        "塩鮭", "1", 
        '[{"name": "パスタ（乾麺）", "quantity": "100", "unit": "g"}, {"name": "焼塩鮭", "quantity": "1", "unit": "切れ"}, {"name": "ほうれん草", "quantity": "1", "unit": "株"}, {"name": "バター", "quantity": "1", "unit": "大さじ"}, {"name": "小麦粉", "quantity": "1", "unit": "大さじ"}, {"name": "牛乳", "quantity": "100", "unit": "cc"}, {"name": "塩コショウ", "quantity": "0", "unit": "適宜"}]', '["焼塩鮭は骨と皮を取ってほぐしておきます。ほうれん草は一口大にカット。", "パスタをゆで始めます。その間にソースの準備。", "耐熱容器にバターと小麦粉を入れてレンジ600Wで1分加熱してよく混ぜます。", "牛乳半量（50cc）を少しずつ加えて混ぜ、再びレンジで1分加熱。", "残りの牛乳（50cc）も同様にし、レンジで1分加熱。塩コショウで調味。", "パスタがゆであがる1分前にほうれん草を投入し、一緒にゆでてしまいます。", "ゆであがったパスタとほうれん草、塩鮭、クリームソース、ゆで汁少々を混ぜてできあがり。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "約30分", "11-71-54", 
        "いわし", "3", 
        '[{"name": "いわし", "quantity": "8", "unit": "~"}, {"name": "梅干し（今回はちみつ漬け）", "quantity": "2", "unit": "個"}, {"name": "酒", "quantity": "2", "unit": "大さじ"}, {"name": "三温糖", "quantity": "2", "unit": "大さじ"}, {"name": "醤油", "quantity": "2", "unit": "大さじ"}, {"name": "みりん", "quantity": "1", "unit": "大さじ"}, {"name": "水", "quantity": "1", "unit": "カップ"}]', '["鰯は頭と腹を取って、流水でキレイに洗いましょう！お腹の中の黒い膜と血合いはしっかりとります！", "お鍋に鰯と梅干しを並べます。器に酒→三温糖→醤油→みりんを合わせて鰯のお鍋に入れます！鰯がつかるギリギリの高さ位までお水をいれて圧力鍋の蓋をし、火をつけます！", "圧がかかってから、23分加圧します。そして自然放置！圧が抜けたら、蓋を開けてお好みの濃さまで煮詰めてね！出来上がり～☆", "☆★ウチの圧力鍋は低圧、高圧の2段階なのですが、高圧で20分加圧しました★☆"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "3", "塩サバの味噌煮★塩サバで簡単クッキング★", "https://recipe.rakuten.co.jp/recipe/1920001977/", 
...
INSERT INTO recipes (
        ...
        "5分以内", "11-78-469", 
        "しらす", "2", 
        '[{"name": "釜揚げしらす", "quantity": "100", "unit": "g"}, {"name": "炊きたてごはん", "quantity": "2", "unit": "丼"}, {"name": "韓国のり", "quantity": "1", "unit": "大"}, {"name": "刻みねぎ", "quantity": "2", "unit": "大さじ"}, {"name": "わさび", "quantity": "0", "unit": "適量"}, {"name": "＜Ａ＞", "quantity": "0", "unit": 0}, {"name": "しょうゆ", "quantity": "50", "unit": "ml"}, {"name": "みりん", "quantity": "10", "unit": "ml"}, {"name": "酒", "quantity": "10", "unit": "ml"}]', '["小鍋にみりん・酒を入れて煮立たせます。煮立ったら醤油を加えてひと煮立ちさせ、火からおろして冷まします。", "丼ぶりに炊き立てごはんをよそい、韓国のりをちぎりながらのせます。", "釜揚げしらすをたっぷりとのせ、刻みねぎを散らし、わさびを添えます。①のたれをかけていただきます。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "約15分", "11-78-469", 
        "しらす", "2", 
        '[{"name": "スパゲッティ", "quantity": "150", "unit": "g"}, {"name": "釜揚げしらす", "quantity": "40", "unit": "g"}, {"name": "白だし", "quantity": "5", "unit": "大さじ"}, {"name": "しそ", "quantity": "4", "unit": "枚"}, {"name": "オリーブ油", "quantity": "2", "unit": "大さじ"}, {"name": "ゆで汁", "quantity": "2", "unit": "大さじ"}, {"name": "白ごま", "quantity": "0", "unit": "お好みで"}]', '["スパゲッティをゆでる。", "フライパンにオリーブ油を入れ温める。スパゲッティ、しらすを入れ絡める。ゆで汁を入れ混ぜ、白だしを入れ、絡めながら混ぜる。", "お皿に盛り付け、しそを刻んで乗せれば出来上がり！お好みでごまをかけてください！"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "指定なし", "11-78-471", 
        "ししゃも", "3", 
        '[{"name": "ししゃも", "quantity": "10", "unit": "本"}, {"name": "☆しょうゆ、みりん、酒", "quantity": "1", "unit": "各大さじ"}, {"name": "☆しょうが、にんにくのすりおろし", "quantity": "0", "unit": "各少々"}, {"name": "片栗粉", "quantity": "0", "unit": "適宜"}, {"name": "サラダ油", "quantity": "0", "unit": "適宜"}]', '["ポリ袋に☆の調味料類、ししゃもを入れ、10分ほどおきます。", "余分な水分をキッチンペーパーでふきとり、片栗粉にまぶします。", "フライパンにししゃもがギリギリかぶるくらいの量のサラダ油を入れ、熱します。両面をカリッとするまで揚げたら完成です。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "3", "揚げずに簡単居酒屋メニュー！ししゃもの南蛮漬け", "https://recipe.rakuten.co.jp/recipe/1920015629/", 
        "https://image.space.rakuten.co.jp/d/strg/ctrl/3/6e374d3d9d398b5d6da82c40e9007a247e0fa093.23.2.3.2.jpg", "300円前後", 
        "約30分", "11-78-471", 
        "ししゃも", "3", 
        '[{"name": "ししゃも", "quantity": "15", "unit": "尾"}, {"name": "※しょうゆ", "quantity": "1", "unit": "大さじ"}, {"name": "※ごま油", "quantity": "1", "unit": "大さじ"}, {"name": "※米酢", "quantity": "1", "unit": "大さじ"}, {"name": "※砂糖", "quantity": "1", "unit": "小さじ"}, {"name": "※鷹の爪", "quantity": "1", "unit": "本"}, {"name": "※しょうが", "quantity": "10", "unit": "g"}, {"name": "小麦粉", "quantity": "1", "unit": "大さじ"}]', '["鷹の爪は種を取り、しょうがはすりおろす。バットに※を混ぜ合わせておく。", "ししゃもに小麦粉を塗し、余分な粉ははたく。熱したフライパンにサラダ油をひき、ししゃもを両面焼き付ける。熱々のうちに漬け汁に浸してできあがり。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "約15分", "11-78-523", 
        "赤魚", "2", 
        '[{"name": "赤魚", "quantity": "2", "unit": "切れ"}, {"name": "生姜", "quantity": "5", "unit": "g"}, {"name": "○酒", "quantity": "100", "unit": "cc"}, {"name": "○醤油", "quantity": "2", "unit": "大さじ"}, {"name": "○砂糖", "quantity": "1", "unit": "大さじ"}, {"name": "○みりん", "quantity": "1", "unit": "大さじ"}]', '["鍋に○の調味料を入れて軽く煮立たせます。", "表面に切り込みを入れた赤魚・薄切りにした生姜を入れます。", "落とし蓋をしふつふつとした状態で4～5分煮ます。", "蓋を取り煮詰め、煮汁がなくなる前に火を消して出来上がりです。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "5分以内", "11-79-1504", 
        "桜えび", "3", 
        '[{"name": "小松菜", "quantity": "200", "unit": "g"}, {"name": "乾桜えび", "quantity": "15", "unit": "g"}, {"name": "ガーリック顆粒", "quantity": "1", "unit": "小さじ"}, {"name": "ごま油", "quantity": "0", "unit": "大さじ半"}, {"name": "塩こしょう", "quantity": "0", "unit": "少々"}]', '["ごま油とガーリック顆粒を入れた中に桜えびを入れて軽く炒めます。", "小松菜は 葉と芯に分け食べやすい長さに切っておきます。", "①に②の芯を先に入れ炒め火を通します。", "③に葉の分を加え炒め 塩こしょうして味を調えます。", "器に盛って出来上がり"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "指定なし", "11-82-63", 
        "はまぐり", "4", 
        '[{"name": "えび", "quantity": "10", "unit": "尾"}, {"name": "ハマグリ", "quantity": "8", "unit": "個"}, {"name": "シーフードミックスのいか", "quantity": "10", "unit": "個"}, {"name": "鱈、鯛", "quantity": "200", "unit": "gずつ"}, {"name": "ホタテの貝柱", "quantity": "10", "unit": "個"}, {"name": "たまねぎ", "quantity": "1", "unit": "個"}, {"name": "にんにく", "quantity": "2", "unit": "かけ"}, {"name": "トマトジュース", "quantity": "3", "unit": "カップ"}, {"name": "酒", "quantity": "1", "unit": "カップ"}, {"name": "コンソメキューブ", "quantity": "2", "unit": "個"}, {"name": "サフラン", "quantity": "2", "unit": "個"}, {"name": "塩", "quantity": "0", "unit": "少々"}, {"name": "バジル粉", "quantity": "1", "unit": "こさじ"}]', '["たまねぎとにんにくをうすぎりにする", "鍋に油をしき、たまねぎとにんにくと塩をいれていためる。しんなりしてきたらトマトジュースと酒とコンソメキューブとサフランをいれてひとにたちさせる", "えび、はまぐり、いか、鱈、鯛、ホタテ、バジル粉をいれて中火で魚介にしっかり火が通るまで４，５分煮たらできあがり"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約30分", "12-100-2", 
        "レタス", "4", 
        '[{"name": "豚ひき肉(合挽きでも)", "quantity": "300", "unit": "g"}, {"name": "玉ねぎ", "quantity": "1", "unit": "小"}, {"name": "トマト", "quantity": "0", "unit": "適量"}, {"name": "レタス", "quantity": "0", "unit": "適量"}, {"name": "とけるチーズ", "quantity": "0", "unit": "適量"}, {"name": "カレー粉", "quantity": "1", "unit": "大さじ"}, {"name": "ケチャップ", "quantity": "5", "unit": "大さじ"}, {"name": "ウスターソース", "quantity": "2", "unit": "大さじ"}, {"name": "塩こしょう", "quantity": "0", "unit": "適量"}, {"name": "ご飯", "quantity": "0", "unit": "人数分"}, {"name": "温泉卵（お好みで）", "quantity": "0", "unit": "人数分"}]', '["玉ねぎはみじん切りにする。レタス、トマトは食べやすい大きさに切る。", "フライパンにサラダ油を熱し、玉ねぎを炒める。しんなりしてきたら、ひき肉を入れ炒める。", "ひき肉の色が変わったらカレー粉、塩コショウを入れ炒める。", "ケチャップ、ウスターソースを入れて、少し炒める。", "ご飯の上に４を乗せ、レタス、トマト、チーズ、温泉卵を盛り付けて完成♪", "☆レンジで温泉卵の作り方☆コップなどの深みのある耐熱容器に卵を割り入れ、かぶる位の水を入れる。爪楊枝で黄身に5箇所穴を開け、ラップせず500wで1分チン。", "辛いのが好きな方はタバスコ追加しても♪マヨネーズも合います(^ ^)", "※『Pickupレシピコーナー』に紹介していただきました。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "指定なし", "12-100-11", 
        "アスパラ", "3", 
        '[{"name": "アスパラ", "quantity": "4", "unit": "本"}, {"name": "ベーコン(ハーフ)", "quantity": "8", "unit": "~"}, {"name": "胡椒", "quantity": "0", "unit": "少々"}]', '["アスパラはベーコンに合わせてカット茎と穂先とで少しの時間差で柔らかくなるまで茹でる。", "ベーコンはハーフベーコンでも1枚を半分に切ってもイイのですがカットしてある方を巻き始めにして巻く", "巻き終わりが真ん中に来るように巻きあげます", "巻き終わりを下にして耐熱皿に並べ、レンジで1分程加熱", "巻き終わりを下にしてフライパンで両面に焼き目を付け完成。好みでブラックペッパーを振ってね"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "約30分", "12-100-859", 
        "新じゃが", "4", 
        '[{"name": "じゃがいも", "quantity": "3", "unit": "中"}, {"name": "玉ねぎ", "quantity": "1", "unit": "中"}, {"name": "お水", "quantity": "200", "unit": "cc"}, {"name": "牛乳", "quantity": "400", "unit": "cc"}, {"name": "顆粒ブイヨン", "quantity": "1", "unit": "大さじ"}, {"name": "塩", "quantity": "1", "unit": "小さじ"}, {"name": "バター", "quantity": "10", "unit": "g"}]', '["玉ねぎをスライスしてバターで炒めます。", "皮を剥いてスライスしたじゃがいもを加えて炒めます。半分火が通ったらお水を加えて煮ます。", "じゃがいもが触って崩れるくらいまで煮たら、フードプロセッサーに入れて、牛乳を加えて撹拌します。", "コンソメと塩を加えて撹拌します。器に盛り付けて完成！"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約30分", "12-100-1530", 
        "たらの芽", "3", 
        '[{"name": "タラの芽", "quantity": "6", "unit": "本"}, {"name": "薄力粉（生地用）", "quantity": "100", "unit": "g"}, {"name": "水", "quantity": "1", "unit": "カップ"}, {"name": "日本酒", "quantity": "30", "unit": "cc"}, {"name": "薄力粉（具にまぶす分）", "quantity": "100", "unit": "g"}]', '["・タラの芽を洗って、袴を取り除きます。", "・計量した薄力粉、水、ボールを冷蔵庫で冷やします。", "・タラの芽の茎に、十字の切り込みを入れます。※タラの芽が小ぶりの時は必要ありません。", "・ボールに水と日本酒、氷少々を入れます。・生地用の薄力粉を加えて、ざっくり混ぜます。", "油を180度に熱しておきます。", "・まぶし用の薄力粉をポリ袋に入れます。・タラの芽を入れて、振りながら、粉を全体にまぶします。", "・余分な粉をはたき落とし、生地をくぐらせます。", "・余分な生地が付いていたら、振り落とします。", "・油に根元の方を入れて、5秒ほど待ちます。・全体を入れます。", "・油の表面が隠れない程度に、次々に、具材を入れます。※具材に火が通っていないうちは、大きい泡になります。・途中具材の裏表を返します。", "・泡が小さくなって、揚げ色が付いたら揚げあがりです。", "網に乗せて、油を切ります。", "・お好みの天つゆなどを用意します。※今日は大根おろし添えの天つゆと、炭塩を用意しました。", "・油を吸い取る紙を敷いた皿に、盛り付けます。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "5分以内", "12-100-317", 
        "クレソン", "2", 
        '[{"name": "クレソン", "quantity": "25", "unit": "g"}, {"name": "茗荷（みょうが）", "quantity": "5", "unit": "g"}, {"name": "ベーコン", "quantity": "1", "unit": "枚"}, {"name": "グレープシードオイル（オリーブ油でも！）", "quantity": "0", "unit": "大匙半"}, {"name": "あれば、ミニトマト", "quantity": "1", "unit": "個"}, {"name": "フレンチドレッシング（市販品）", "quantity": "20", "unit": "cc位"}, {"name": "↑", "quantity": "0", "unit": 0}, {"name": "新鮮な手作りがお勧めです♪", "quantity": "0", "unit": 0}]', '["ベーコンを１ｃｍ幅程度に切って、油したフライパン弱火で色が付くまで炒める。", "ミョウガを小口切りし、３つ位の長さにカットしたクレソンと混ぜ皿に乗せる。トマトは縦４つに切って飾る。", "１．をオイルごと２．にかける。ドレッシングをかけてお召し上がり下さい。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約10分", "12-101-31", 
        "ゴーヤ", "2", 
        '[{"name": "ゴーヤ", "quantity": "1", "unit": "本"}, {"name": "ツナ", "quantity": "50", "unit": "g"}, {"name": "★塩", "quantity": "0", "unit": "少々"}, {"name": "★マヨネーズ", "quantity": "10", "unit": "g"}, {"name": "（ミニトマト）", "quantity": "2", "unit": "("}]', '["ゴーヤを薄めに切る。沸騰したお湯に入れて塩ゆでする。（１分）ざるにあげて、軽くしぼる。", "ボールに、ゴーヤ、油きりしたツナ、★を入れ、混ぜ合わせたら出来上がり！トマトを飾るとキレイです。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "約15分", "12-101-32", 
        "オクラ", "4", 
        '[{"name": "なす", "quantity": "3", "unit": "本"}, {"name": "オクラ", "quantity": "1", "unit": "パック"}, {"name": "大根", "quantity": "10", "unit": "センチ"}, {"name": "めんつゆ（ストレート）", "quantity": "1", "unit": "カップ"}, {"name": "サラダ油", "quantity": "2", "unit": "大さじ"}]', '["大根はすりおろし、麺つゆと混ぜておく。麺つゆが濃縮タイプのものは薄めてください。", "オクラは網のパックに入れたまま塩（分量外）を振りかけ、こすり合わせるように洗い、額のフチを剥く。沸騰した湯に入れてサッと茹で、ザルに上げておく。", "ナスは、縦4等分に切る。フライパンに油を熱し、ナスを皮目から焼く。", "じっくり焼いて、しんなりしてきたらパタンと倒して焼く。焼き色がついたら同じように倒し3面焼く。", "焼きあがったら1の麺つゆにドンドン入れていく。", "オクラも少し焼き色がつく程度に焼いて麺つゆにつける。", "出来立ての熱々も…冷蔵庫で冷やしても…どちらも美味しいです♪", "簡単！揚げない！揚げ出し豆腐レシピID 1890004637も是非(^^)", "pickupレシピに掲載していただきました(*´꒳`*)"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約15分", "12-101-456", 
        "パプリカ", "4", 
        '[{"name": "なす", "quantity": "2", "unit": "本"}, {"name": "きゅうり", "quantity": "2", "unit": "本"}, {"name": "おくら", "quantity": "4", "unit": "本"}, {"name": "ピーマン", "quantity": "1", "unit": "個"}, {"name": "パプリカ(赤)", "quantity": "1", "unit": "個"}, {"name": "パプリカ(黄)", "quantity": "1", "unit": "個"}, {"name": "白だし", "quantity": "150", "unit": "cc"}, {"name": "水", "quantity": "200", "unit": "cc"}, {"name": "はちみつ", "quantity": "1", "unit": "大さじ"}]', '["なす、ピーマン、パプリカ、キュウリ、オクラを1.5センチ幅くらいに揃えて切る。(食べやすい大きさで大丈夫です)", "漬け汁を作ります。白だし、水、はちみつを容器にいれて混ぜておく。", "1の野菜を少なめの油で揚げ、よく油をきり、つけ汁に入れる。", "熱いままでも、冷やしても。お好きな状態で召し上がれ。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "約30分", "12-103-308", 
        "里芋", "4", 
        '[{"name": "里芋", "quantity": "20", "unit": "個"}, {"name": "片栗粉", "quantity": "3", "unit": "大さじ"}, {"name": "●醤油", "quantity": "2", "unit": "大さじ"}, {"name": "●砂糖", "quantity": "1", "unit": "大さじ"}, {"name": "●みりん", "quantity": "1", "unit": "大さじ"}, {"name": "●酢", "quantity": "1", "unit": "小さじ"}, {"name": "揚げ油", "quantity": "0", "unit": "適量"}]', '["里芋は皮ごと洗って、上下を切り落とし、5分茹でたら水で冷やしながら包丁で皮を剥き、ひと口大に切る。里芋に片栗粉をまぶしたら手でギュッと握ってなじませ、しばらく置く。", "フライパンに●を軽く温め砂糖を溶かして、甘辛たれを作っておく。１の里芋を１８０~１９０度の油で片栗粉がカリッとなるまで揚げる。", "甘辛たれを中火にかけ、揚げた里芋をたれと絡めるように軽く炒めたら出来上がり♪＊焦げないように注意して下さい‼︎"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "指定なし", "12-104-1960", 
        "その他の野菜", "4", 
        '[{"name": "春雨", "quantity": "60", "unit": "g"}, {"name": "ハム", "quantity": "4", "unit": "枚"}, {"name": "キュウリ", "quantity": "1", "unit": "本"}, {"name": "人参", "quantity": "6", "unit": "cm"}, {"name": "卵", "quantity": "1", "unit": "個"}, {"name": "A　砂糖", "quantity": "5", "unit": "大さじ"}, {"name": "A　酢", "quantity": "5", "unit": "大さじ"}, {"name": "A　醤油", "quantity": "5", "unit": "大さじ"}, {"name": "A　ゴマ油", "quantity": "5", "unit": "大さじ"}, {"name": "A　水", "quantity": "240", "unit": "ml"}, {"name": "いりごま(白)", "quantity": "1", "unit": "大さじ"}]', '["溶き卵を薄く焼いて錦糸卵を作る。ハム、キュウリ、人参は千切りにする。鍋に春雨を入れて、ハム、人参をのせる。", "Aを加えて煮る。火を止めて少し混ぜフタをして冷ます。", "錦糸卵、キュウリ、いりゴマを加えて混ぜる。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "5分以内", "12-107-856", 
        "万能ねぎ", "2", 
        '[{"name": "厚揚げ(絹揚げ)", "quantity": "2", "unit": "四角いの"}, {"name": "青ネギ", "quantity": "1", "unit": "束"}, {"name": "◎醤油", "quantity": "2", "unit": "大さじ"}, {"name": "◎生姜のすりおろし(チューブで可)", "quantity": "4", "unit": "~"}, {"name": "◎にんにくのすりおろし(チューブで可)", "quantity": "3", "unit": "~"}, {"name": "◎砂糖", "quantity": "2", "unit": "小さじ"}, {"name": "◎酒", "quantity": "2", "unit": "大さじ"}, {"name": "◎豆板醤", "quantity": "3", "unit": "小さじ"}, {"name": "ごま油", "quantity": "1", "unit": "大さじ"}]', '["厚揚げ(絹揚げ)は一口大に切る。", "青ネギは小口切りにし、◎を合わせておく。", "フライパンにごま油を入れて熱し、厚揚げをカリッと焼く。", "◎を入れて絡める様に炒める。", "青ネギを入れてサッと混ぜる。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
...
INSERT INTO recipes (
        ...
        "4", "小さなおかず♪ちくわとニラの豆板醤炒め。", "https://recipe.rakuten.co.jp/recipe/1900001910/", 
        "https://image.space.rakuten.co.jp/d/strg/ctrl/3/5080e04f956ee352f08247a9244c118c2df7f3bd.56.2.3.2.jpg", "指定なし", 
        "指定なし", "13-108-108", 
        "その他の練物", "2", 
        '[{"name": "ちくわ", "quantity": "1", "unit": "袋"}, {"name": "ニラ", "quantity": "1", "unit": "束"}, {"name": "おろしにんにく", "quantity": "0", "unit": "少々"}, {"name": "ごま油", "quantity": "1", "unit": "小さじ"}, {"name": "湯（中華スープに使用）", "quantity": "50", "unit": "cc"}, {"name": "中華スープの素", "quantity": "0", "unit": "少々"}, {"name": "豆板醤", "quantity": "2", "unit": "小さじ"}, {"name": "酒", "quantity": "1", "unit": "大さじ"}]', '["ちくわは斜め切り。ニラは食べやすい長さに切る。湯と中華スープの素は溶いておく。", "フライパンにごま油を中火で熱し、にんにくを炒める。香りが出たらちくわを加え、中華スープ、豆板醤、酒を加えいためる。", "ニラを加えていためて完成。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "3", "味付けなしの手抜き料理、さば味噌煮缶のキムチ豆腐", "https://recipe.rakuten.co.jp/recipe/1030004198/", 
        "https://image.space.rakuten.co.jp/d/strg/ctrl/3/952151d423813ecf53be714a53b8b2afbb8b6dba.39.2.3.2.jpg", "300円前後", 
        "約10分", "13-109-531", 
        "缶詰", "2", 
        '[{"name": "さば味噌煮缶", "quantity": "140", "unit": "缶("}, {"name": "キムチ（辛口）", "quantity": "200", "unit": "g"}, {"name": "豆腐(木綿）", "quantity": "350", "unit": "丁("}, {"name": "青ネギ", "quantity": "1", "unit": "本"}]', '["豆腐は８つに食べやすく切る（お皿に乗せておくと水がドンドン出てくるので、ドンドン捨てる）キムチはざく切り。青ネギは小口切り。", "鍋に豆腐を並べ、その上にキムチ、さば缶の身を大きくほぐしながら、汁も全部入れる。空いた缶に水を1/4ほど入れて、上から回しかけ、フタを閉めて中火で煮る。", "５～６分して、全体に火がまわり、豆腐が煮えたら火を止める", "お皿に取り分け、上に小口切りにした青ネギを乗せて出来上がり。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
        ...
        "4", "キャベツと鶏肉のトマト煮", "https://recipe.rakuten.co.jp/recipe/1330008600/", 
        "https://image.space.rakuten.co.jp/d/strg/ctrl/3/d402a514798ee5af9170732b9b8a92fa2067815f.45.2.3.2.jpg", "指定なし", 
        "指定なし", "13-109-1638", 
        "トマト缶", "3", 
        '[{"name": "キャベツ", "quantity": "150", "unit": "g"}, {"name": "たまねぎ", "quantity": "1", "unit": "中"}, {"name": "鶏もも肉", "quantity": "1", "unit": "枚"}, {"name": "（鶏の下味）塩・こしょう", "quantity": "0", "unit": "少々"}, {"name": "スライスにんにく", "quantity": "0", "unit": "少々"}, {"name": "カットトマト缶", "quantity": "400", "unit": "缶("}, {"name": "水", "quantity": "100", "unit": "cc"}, {"name": "☆顆粒コンソメ", "quantity": "2", "unit": "小さじ"}, {"name": "☆さとう", "quantity": "2", "unit": "小さじ"}, {"name": "塩・こしょう", "quantity": "0", "unit": "少々"}, {"name": "パセリ", "quantity": "0", "unit": "少々"}]', '["キャベツはざく切り玉ねぎは薄切りにする", "鶏肉は一口大に切り、塩こしょうを揉みこむ", "フライパンに鶏肉とにんにくを入れ、焼き色がつくまで焼く（半生でＯＫ）玉ねぎを加え、しんなりするまで、さらに炒める", "トマト缶と水、キャベツを加え、蓋をし、５分煮る☆の調味料で味付けし、また蓋をして２０分～２５分、全体がクッタリするまで煮る", "塩・こしょうで味を整え、皿に盛り、千切ったパセリを散らす"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
