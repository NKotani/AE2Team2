...
INSERT INTO recipes (
        ...
        "約10分", "13-109-531", 
        "缶詰", "2", 
        '[{"name": "さば味噌煮缶", "quantity": "1", "unit": "缶"}, {"name": "キムチ（辛口）", "quantity": "200", "unit": "g"}, {"name": "豆腐(木綿）", "quantity": "350", "unit": "丁("}, {"name": "青ネギ", "quantity": "1", "unit": "本"}]', '["豆腐は８つに食べやすく切る（お皿に乗せておくと水がドンドン出てくるので、ドンドン捨てる）キムチはざく切り。青ネギは小口切り。", "鍋に豆腐を並べ、その上にキムチ、さば缶の身を大きくほぐしながら、汁も全部入れる。空いた缶に水を1/4ほど入れて、上から回しかけ、フタを閉めて中火で煮る。", "５～６分して、全体に火がまわり、豆腐が煮えたら火を止める", "お皿に取り分け、上に小口切りにした青ネギを乗せて出来上がり。"]'
    );
INSERT INTO recipes (
        recipeRank, recipeTitle, recipeUrl, foodImageUrl, 
        recipeCost, recipeIndication, categoryId, 
